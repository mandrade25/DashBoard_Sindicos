...
## Prompt Otimizado para Claude Code
...
## Frontend Skill — Instrução para Claude Code

> **IMPORTANTE para o Claude Code:** Antes de escrever qualquer componente de UI, leia e
