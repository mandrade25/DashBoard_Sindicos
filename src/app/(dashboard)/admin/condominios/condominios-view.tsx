        ...
        <div className="rounded-xl border border-slate-200 bg-white">
          <Table>
            ...
            <TableBody>
              {items.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={5} className="py-12 text-center text-sm text-minimerx-gray">
                ...
                items.map((c) => (
                  <TableRow key={c.id}>
                    ...
                    <TableCell className="text-sm text-minimerx-gray">
                      {c.dataInicio ? new Date(c.dataInicio + "T12:00:00").toLocaleDateString("pt-BR", { month: "2-digit", year: "numeric" }) : "—"}
                    </TableCell>
                    <TableCell>
                      {c.sindico ? (
                        <div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="dataInicio">Mês de início das operações</Label>
                <Input
                  id="dataInicio"
                  tabIndex={3}
                  type="month"
                  ...
                  required
                />
                <p className="text-xs text-minimerx-gray">Usado para calcular pendências de comprovante.</p>
              </div>
